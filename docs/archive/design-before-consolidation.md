...
> Historical snapshot, archived 2026-09-12 from commit `73cb13c` during design
> consolidation. This includes the original compute-focused analysis and later
> design notes. It is NOT the current specification or roadmap. External project
> descriptions and comparisons have not been reverified during consolidation.
> See [the current design](../design.md) for implemented contracts and open decisions.
